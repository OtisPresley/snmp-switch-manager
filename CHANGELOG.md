...
### Added
- 🌐 **Polish Language Translation Support**: Added full Polish (`pl`) translation and strings files across all configuration and options flow steps in both `strings/` and `translations/` directories.
